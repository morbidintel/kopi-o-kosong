...
public class DrinkTypes : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        drinkTypes.Add("kopi kosong",   new int[] { 0, 1, 0, 0, 0, 0 });
        ...
        drinkTypes.Add("kopi kosong peng", new int[] { 0, 1, 0, 0, 0, 1 });
        ...
        drinkTypes.Add("teh kosong",    new int[] { 0, 0, 1, 0, 0, 0 });
        ...
        drinkTypes.Add("teh kosong peng", new int[] { 0, 0, 1, 0, 0, 1 });
